...
describe Graph do
    context "#get_path" do
        it "finds a path" do
            hash = {0 => [2], 1 => [4], 2 => [5, 0, 3], 3 => [2], 4 => [1, 5], 5 => [4, 2]}
            path = Graph.new(hash).get_path(0, 4)
            path_found = path[0].data == 0 and path[-1].data == 4
        ...
        it "finds a path" do
            ...
            path_found = path[0].data == 0 and path[-1].data == 8
            expect(path_found).to eql true
        end
    ...
    context "#breadth_first_search" do
        ...
        it "returns array in BFS form" do
            hash = {0 => [1, 2, 3], 1 => [0, 4, 5], 2 => [0, 5, 6], 3 => [0, 7, 8, 9], 4 => [1, 10, 11], 5 => [1, 2, 12], 6 => [2, 13], 7 => [3], 8 => [3], 9 => [3], 10 => [4], 11 => [4], 12 => [5], 13 => [6]}
            res = []
            Graph.new(hash).breadth_first_search(0) { |n| res << n.data }
    ...
    context "#depth_first_search" do
        ...
        it "returns array in DFS form" do
            hash = {0 => [1, 2, 3], 1 => [0, 4, 5], 2 => [0, 5, 6], 3 => [0, 7, 8, 9], 4 => [1, 10, 11], 5 => [1, 2, 12], 6 => [2, 13], 7 => [3, 14], 8 => [3], 9 => [3], 10 => [4], 11 => [4], 12 => [5], 13 => [6], 14 => [7]}
            res = []
            Graph.new(hash).depth_first_search(0) { |n| res << n.data }
