...
RSpec.describe Sorter do
  ...
  context ".insertion_sort_running_time" do
...
=begin
        ...
        1 1 2 2 3 : 3+1=4
=end
      expect(Sorter.insertion_sort_running_time(array)).to eql 4
    end
...
=end
    ...
    it "correctly counts the number of shifts needed to sort array of length 100" do
      ...
      expect(Sorter.insertion_sort_running_time(array)).to eql 2856
    end
  end
